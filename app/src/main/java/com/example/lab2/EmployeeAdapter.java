...
public class EmployeeAdapter extends ArrayAdapter<Employee5> {
    private Activity context;
    public EmployeeAdapter(Activity context, int layoutID, List<Employee5> objects) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent)
    {
        ...
        // Get item
        Employee5 employee = getItem(position);
        // Get view
